...
class LivrosModel:
    ...
    def create_livro(self, titulo:str, autor: str, ano:int, preco:float):
        try:
            ...
            print(f"Livro criado com a id: {res.inserted_id}")
    ...
    def update_livro(self, id: str, titulo:str, autor: str, ano:int, preco:float):
        try:
            ...
            print(f"Livro atualizado: {res.modified_count} document(s) modified")
    ...
    def delete_livro(self, id: str):
        try:
            ...
            print(f"Livro deletado: {res.deleted_count} document(s) deleted")
